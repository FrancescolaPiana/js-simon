...
function fx() {
    ...
    if (cutdown < -1) {
        ...
        setTimeout (document.getElementById('timer').innerHTML = (`<span><input type="number" name="" id="casella"></span> <span><button id="btn" type="submit"><i class="fa-solid fa-upload"></i></button></span>`) , 7000 )
